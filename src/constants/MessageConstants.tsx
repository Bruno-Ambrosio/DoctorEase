export const MessageConstants= {
    WEAK_PASSWORD: 'Password must contain eight characters and at least one number!',
    SUCCES_LOGOUT: 'Session succesfully terminated.',
    BLANK_FIELDS: 'Please enter all fields to continue.',
